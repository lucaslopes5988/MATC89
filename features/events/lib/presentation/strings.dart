...
abstract final class EventsStrings {
  ...
  static const createTitleLabel = 'Título';
  static const createSportLabel = 'Esporte';
  static const createLocationLabel = 'Local';
  static const createDateLabel = 'Data';
  static const createTimeLabel = 'Horário';
  static const createDescriptionLabel = 'Descrição';
  ...
  static const createDateTimeRequired = 'Informe data e horário';
  static const createFutureDateRequired = 'Informe um horário futuro';
  static const requiredField = 'Campo obrigatório';
  static const invalidMaxParticipants = 'Informe um número maior que zero';
  static const womenOnlyRestricted = 'Este evento é exclusivo para mulheres';
  static const mapEmptyMessage =
      'Nenhum evento com localização para mostrar no mapa.';
